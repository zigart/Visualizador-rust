...
- [ ] 2.1 Definir tipos de dominio para bicicletas, estaciones, recorridos, eventos y timestamps.
- [ ] 2.2 Definir errores de negocio con `thiserror`.
- [ ] 2.3 Definir traits de puertos para recorridos, estado de bicicletas y publicacion de actualizaciones.
...
- [ ] 4.2 Implementar consumidor `lapin` para la cola configurada, con default `bike_trips`.
